<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">STUDENTS@CADT.EDU.KH.IN</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="developer">
			<h3> Developed by "CADT STUDENTS"</h3>
			</div>

			<div class="copyright">
			&copy; <?php echo date("Y");?> Fashion Boutique &trade;
			</div>

			<div class="designby">
			Design by :- <br>Chort sereivathana<br>Chea Virakbott <br> Va Navin <br> Ou Sengly<br>
			</div>
		</div>
	</div>
</footer>
